...
public class PagosRecibosAutorizarBE {
	...
	public static String GstrLNK_ENVIAR_EMAIL_AUTORIZAR_RESULTADO_ESPERADO=Mdl_Variables.Gstr_Ignore;
	public static String GstrBTN_ACEPTAR_CORREO_AUTORIZAR_RESULTADO_ESPERADO=Mdl_Variables.Gstr_Ignore;
	public static String GstrTXT_CORREO_AUTORIZAR_RESULTADO_ESPERADO=Mdl_Variables.Gstr_Ignore;
	public static String GstrTXT_MENSAJE_CORREO_AUTORIZAR_RESULTADO_ESPERADO=Mdl_Variables.Gstr_Ignore;
	public static String GstrBTN_ENVIAR_CORREO_AUTORIZAR_RESULTADO_ESPERADO=Mdl_Variables.Gstr_Ignore;
	public static String GstrLNK_EXPORTAR_EXCEL_AUTORIZAR_RESULTADO_ESPERADO=Mdl_Variables.Gstr_Ignore;
	public static String GstrLNK_EXPORTAR_PDF_AUTORIZAR_RESULTADO_ESPERADO=Mdl_Variables.Gstr_Ignore;
	public static String GstrLNK_IMPRIMIR_AUTORIZAR_RESULTADO_ESPERADO=Mdl_Variables.Gstr_Ignore;
	
		public boolean PagosRecibosAutorizar(ResultSet Rst_Funcionalidad){
			...
			try {
				...
				GstrLNK_ENVIAR_EMAIL_AUTORIZAR_RESULTADO_ESPERADO = Rst_Funcionalidad.getObject("LNK_ENVIAR_EMAIL_AUTORIZAR_RESULTADO_ESPERADO") != null ? Rst_Funcionalidad.getString("LNK_ENVIAR_EMAIL_AUTORIZAR_RESULTADO_ESPERADO") : Mdl_Variables.Gstr_Ignore;
				GstrTXT_CORREO_AUTORIZAR_RESULTADO_ESPERADO= Rst_Funcionalidad.getObject("TXT_CORREO_AUTORIZAR_RESULTADO_ESPERADO") != null ? Rst_Funcionalidad.getString("TXT_CORREO_AUTORIZAR_RESULTADO_ESPERADO") : Mdl_Variables.Gstr_Ignore;
				GstrTXT_MENSAJE_CORREO_AUTORIZAR_RESULTADO_ESPERADO= Rst_Funcionalidad.getObject("TXT_MENSAJE_CORREO_AUTORIZAR_RESULTADO_ESPERADO") != null ? Rst_Funcionalidad.getString("TXT_MENSAJE_CORREO_AUTORIZAR_RESULTADO_ESPERADO") : Mdl_Variables.Gstr_Ignore;
				GstrBTN_ENVIAR_CORREO_AUTORIZAR_RESULTADO_ESPERADO= Rst_Funcionalidad.getObject("BTN_ENVIAR_CORREO_AUTORIZAR_RESULTADO_ESPERADO") != null ? Rst_Funcionalidad.getString("BTN_ENVIAR_CORREO_AUTORIZAR_RESULTADO_ESPERADO") : Mdl_Variables.Gstr_Ignore;
				GstrBTN_ACEPTAR_CORREO_AUTORIZAR_RESULTADO_ESPERADO= Rst_Funcionalidad.getObject("BTN_ACEPTAR_CORREO_AUTORIZAR_RESULTADO_ESPERADO") != null ? Rst_Funcionalidad.getString("BTN_ACEPTAR_CORREO_AUTORIZAR_RESULTADO_ESPERADO") : Mdl_Variables.Gstr_Ignore;
				GstrLNK_EXPORTAR_EXCEL_AUTORIZAR_RESULTADO_ESPERADO = Rst_Funcionalidad.getObject("LNK_EXPORTAR_EXCEL_AUTORIZAR_RESULTADO_ESPERADO") != null ? Rst_Funcionalidad.getString("LNK_EXPORTAR_EXCEL_AUTORIZAR_RESULTADO_ESPERADO") : Mdl_Variables.Gstr_Ignore;
				GstrLNK_EXPORTAR_PDF_AUTORIZAR_RESULTADO_ESPERADO = Rst_Funcionalidad.getObject("LNK_EXPORTAR_PDF_AUTORIZAR_RESULTADO_ESPERADO") != null ? Rst_Funcionalidad.getString("LNK_EXPORTAR_PDF_AUTORIZAR_RESULTADO_ESPERADO") : Mdl_Variables.Gstr_Ignore;
				GstrLNK_IMPRIMIR_AUTORIZAR_RESULTADO_ESPERADO = Rst_Funcionalidad.getObject("LNK_IMPRIMIR_AUTORIZAR_RESULTADO_ESPERADO") != null ? Rst_Funcionalidad.getString("LNK_IMPRIMIR_AUTORIZAR_RESULTADO_ESPERADO") : Mdl_Variables.Gstr_Ignore;

...
public class TransfEntreCuentasPortabilidadBE { 
	...
	public static String GstrLNK_TRANSFERENCIAS = Mdl_Variables.Gstr_Ignore;
	public static String GstrEMPRESA = Mdl_Variables.Gstr_Ignore;
	...
	public static String GstrLNK_MOSTRAR_CLAVE = Mdl_Variables.Gstr_Ignore;
	...
	public static String GstrTXT_CLAVE_ERRONEA = Mdl_Variables.Gstr_Ignore;
	public static String GstrTXT_CLAVE_ERRONEA_MIN = Mdl_Variables.Gstr_Ignore;
	public static String GstrTXT_CLAVE_ERRONEA_MAX = Mdl_Variables.Gstr_Ignore;
	...
	public static String GstrTXT_NUMERO_TICKET_ESPECIAL= Mdl_Variables.Gstr_Ignore;
	public boolean obtenerCamposBD(ResultSet Rst_Funcionalidad){
		...
		try{
			...
			GstrLNK_TRANSFERENCIAS = Rst_Funcionalidad.getObject("LNK_TRANSFERENCIAS") != null ? Rst_Funcionalidad.getString("LNK_TRANSFERENCIAS") : Mdl_Variables.Gstr_Ignore;
			GstrEMPRESA = Rst_Funcionalidad.getObject("EMPRESA") != null ? Rst_Funcionalidad.getString("EMPRESA") : Mdl_Variables.Gstr_Ignore;
			...
			GstrLNK_MOSTRAR_CLAVE = Rst_Funcionalidad.getObject("LNK_MOSTRAR_CLAVE") != null ? Rst_Funcionalidad.getString("LNK_MOSTRAR_CLAVE") : Mdl_Variables.Gstr_Ignore;
			...
			GstrBTN_ENVIAR_CORREO = Rst_Funcionalidad.getObject("BTN_ENVIAR") != null ? Rst_Funcionalidad.getString("BTN_ENVIAR") : Mdl_Variables.Gstr_Ignore;
			GstrBTN_CERRAR_CORREO = Rst_Funcionalidad.getObject("BTN_CERRAR_EMAIL") != null ? Rst_Funcionalidad.getString("BTN_CERRAR_EMAIL") : Mdl_Variables.Gstr_Ignore;
			...
			GstrTXT_CLAVE_ERRONEA = Rst_Funcionalidad.getObject("TXT_CLAVE_ERRONEA") != null ? Rst_Funcionalidad.getString("TXT_CLAVE_ERRONEA") : Mdl_Variables.Gstr_Ignore;
			GstrTXT_CLAVE_ERRONEA_MIN = Rst_Funcionalidad.getObject("TXT_CLAVE_ERRONEA_MIN") != null ? Rst_Funcionalidad.getString("TXT_CLAVE_ERRONEA_MIN") : Mdl_Variables.Gstr_Ignore;
			GstrTXT_CLAVE_ERRONEA_MAX = Rst_Funcionalidad.getObject("TXT_CLAVE_ERRONEA_MAX") != null ? Rst_Funcionalidad.getString("TXT_CLAVE_ERRONEA_MAX") : Mdl_Variables.Gstr_Ignore;
			...
			GstrBTN_CONSULTA_SALDOS=Rst_Funcionalidad.getObject("CONSULTAR_SALDOS_MOVIMIENTOS")!=null?Rst_Funcionalidad.getString("CONSULTAR_SALDOS_MOVIMIENTOS"):Mdl_Variables.Gstr_Ignore;
			...
			GstrTXT_NUMERO_TICKET_ESPECIAL=Rst_Funcionalidad.getObject("TXT_NUMERO_TICKET_ESPECIAL")!=null?Rst_Funcionalidad.getString("TXT_NUMERO_TICKET_ESPECIAL"):Mdl_Variables.Gstr_Ignore;

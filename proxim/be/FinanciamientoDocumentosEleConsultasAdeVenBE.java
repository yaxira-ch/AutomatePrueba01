...
public class FinanciamientoDocumentosEleConsultasAdeVenBE {
	...
	public static String GstrBTN_CERRAR_POPUP =Mdl_Variables.Gstr_Ignore;
	public static String GstrTXT_TITULO_POPUP =Mdl_Variables.Gstr_Ignore;
	...
	public static String GstrTXT_PROVEEDOR =Mdl_Variables.Gstr_Ignore;
	public static String GstrCMB_TIPO_BUSQUEDA =Mdl_Variables.Gstr_Ignore;
	...
	public static String GstrLBL_SIN_RESULTADO =Mdl_Variables.Gstr_Ignore;
	...
	public static String GstrVERIFICAR_NUM_INTERNO=Mdl_Variables.Gstr_Ignore;
	...
	public boolean obtenerCamposBD(ResultSet Rst_Funcionalidad){
		...
		try{
			...
			GstrBTN_CERRAR_POPUP = Rst_Funcionalidad.getObject("BTN_CERRAR_POPUP") != null ? Rst_Funcionalidad.getString("BTN_CERRAR_POPUP") : Mdl_Variables.Gstr_Ignore;
			GstrTXT_TITULO_POPUP = Rst_Funcionalidad.getObject("TXT_TITULO_POPUP") != null ? Rst_Funcionalidad.getString("TXT_TITULO_POPUP") : Mdl_Variables.Gstr_Ignore;
			...
			GstrTXT_PROVEEDOR = Rst_Funcionalidad.getObject("TXT_PROVEEDOR") != null ? Rst_Funcionalidad.getString("TXT_PROVEEDOR") : Mdl_Variables.Gstr_Ignore;
			...
			GstrLBL_SIN_RESULTADO = Rst_Funcionalidad.getObject("LBL_SIN_RESULTADO") != null ? Rst_Funcionalidad.getString("LBL_SIN_RESULTADO") : Mdl_Variables.Gstr_Ignore;
			...
			GstrVERIFICAR_NUM_INTERNO= Rst_Funcionalidad.getObject("VERIFICAR_NUM_INTERNO") != null ? Rst_Funcionalidad.getString("VERIFICAR_NUM_INTERNO") : Mdl_Variables.Gstr_Ignore;

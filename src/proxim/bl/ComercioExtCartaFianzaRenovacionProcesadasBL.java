...
public class ComercioExtCartaFianzaRenovacionProcesadasBL extends ComercioExtCartaFianzaGeneralBE{

	FuncionesGenerales objFuncionesGenerales = new FuncionesGenerales();
	ConexionSqlServer objSQL = new  ConexionSqlServer();
	ConexionBL objConexionBL = new ConexionBL();
	ComercioExtCartaFianzaRenovacionProcesadasMapeo objComercioExtCartaFianzaRenovacionMapeo = new ComercioExtCartaFianzaRenovacionProcesadasMapeo();
	...
	public boolean comercioExtCartaFianzaSolicitudProcesadas(int valor) throws SQLException, IOException{
		...
		try {
			...
			if(valor==2){
				...
				objComercioExtCartaFianzaRenovacionMapeo.verificarCamposObligatoriosSolicitud();
			}
			...
			if (objFuncionesGenerales.verificarIgnore( LstrTXT_SUBMENU1)){	
				...
				if (objComercioExtCartaFianzaRenovacionMapeo.seleccionarSubMenu1( LstrTXT_SUBMENU1))
				{	
			...
			objComercioExtCartaFianzaRenovacionMapeo.verificarCamposObligatoriosProcesados();
			
			if (objFuncionesGenerales.verificarIgnore( GstrCMB_EMPRESA)){	
				LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  
				
				if (objComercioExtCartaFianzaRenovacionMapeo.seleccionarEmpresaProcesadas( GstrCMB_EMPRESA))
				{	
			...
			if (objFuncionesGenerales.verificarIgnore( fechaBusqueda)){	
				...
				if (objComercioExtCartaFianzaRenovacionMapeo.ingresarFechaOperacionDesdeProcesadas( fechaBusqueda))
				{	
			...
			if (objFuncionesGenerales.verificarIgnore( fechaBusqueda)){	
				...
				if (objComercioExtCartaFianzaRenovacionMapeo.ingresarFechaOperacionHastaProcesadas( fechaBusqueda))
				{	
			...
			if (objFuncionesGenerales.verificarIgnore(EstadoOperacion)){	
				...
				if (objComercioExtCartaFianzaRenovacionMapeo.seleccionarEstadoOperacionProcesadas( EstadoOperacion))
				{	
			...
			if (objFuncionesGenerales.verificarIgnore(ComercioExtCartaFianzaGeneralBE.GstrLBN_NUMERO_CARTA_FIANZA )){	
				...
				if (objComercioExtCartaFianzaRenovacionMapeo.ingresarNumeroCartaFianzaProcesadas(ComercioExtCartaFianzaGeneralBE.GstrLBN_NUMERO_CARTA_FIANZA ))
				{	
			...
			if (objFuncionesGenerales.verificarIgnore( "CLICK")){	
				...
				if (objComercioExtCartaFianzaRenovacionMapeo.ingresoBotonBuscarProcesadas()){	
			...
			if (objFuncionesGenerales.verificarIgnore( "CLICK")){	
				LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  
				objComercioExtCartaFianzaRenovacionMapeo.verificarTablaProcesados();
				if (objComercioExtCartaFianzaRenovacionMapeo.seleccionarSolicitudProcesada()){	
			...
			{	
				LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  
				if (objComercioExtCartaFianzaRenovacionMapeo.ingresoLinkEnviarEmailFinalProcesadaTotal()){	
			...
			{	
				LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  	
				if (objComercioExtCartaFianzaRenovacionMapeo.ingresarCorreoFinalProcesada( GstrTXT_CORREO_PROCESADO))
				{	
			...
			{	
				LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  	
				if (objComercioExtCartaFianzaRenovacionMapeo.ingresarMensajeCorreoFinalProcesada( GstrTXT_MENSAJE_CORREO_PROCESADO))
				{	
			...
			{	
				LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  
				if (objComercioExtCartaFianzaRenovacionMapeo.ingresoBotonEnviarFinalProcesada()){	
					objFuncionesGenerales.callPasosAcierto(1, "", "" ,"en el botón ENVIAR");
					TipoLog="1";
					Thread.sleep(1000);
					objComercioExtCartaFianzaRenovacionMapeo.ingresoBotonAceptarEnviarFinalProcesada();
				}else{
					TipoLog="0";			
					bandera = false;
			...
			{	
				LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  
				if (objComercioExtCartaFianzaRenovacionMapeo.ingresoLinkExportarExcelFinalProcesadaTotal()){	
			...
			{	
				LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  
				if (objComercioExtCartaFianzaRenovacionMapeo.ingresoLinkExportarPDFFinalProcesadaTotal()){	
			...
			{	
				LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  
				if (objComercioExtCartaFianzaRenovacionMapeo.ingresoLinkImprimirFinalProcesadaTotal()){	
			...
			if(bandera){
				if (objFuncionesGenerales.verificarIgnore( "CLICK")){	
					...
					if (objComercioExtCartaFianzaRenovacionMapeo.VerDetalleProcesada()){	
						objFuncionesGenerales.callPasosAcierto(1, "", "" ,"en la Solicitud Procesada");
						TipoLog="1";
						Thread.sleep(500);
					}else{
				...
				{	
					LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  
					if (objComercioExtCartaFianzaRenovacionMapeo.ingresoLinkEnviarEmailFinalProcesada()){	
						objFuncionesGenerales.callPasosAcierto(1, "", "" ,"en el Link Enviar Email");
						TipoLog="1";
					}else{
						TipoLog="0";			
				...
				{	
					LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  
					if (objComercioExtCartaFianzaRenovacionMapeo.ingresoLinkExportarExcelFinalProcesada()){	
						objFuncionesGenerales.callPasosAcierto(1, "", "" ,"en el Link Exportar EXCEL");
						TipoLog="1";
					}else{
						TipoLog="0";			
				...
				{	
					LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  
					if (objComercioExtCartaFianzaRenovacionMapeo.ingresoLinkExportarPDFFinalProcesada()){	
						objFuncionesGenerales.callPasosAcierto(1, "", "" ,"en el Link Exportar PDF");
						TipoLog="1";
					}else{
						TipoLog="0";			
				...
				{	
					LStr_HoraInicio = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(Calendar.getInstance().getTime());	  
					if (objComercioExtCartaFianzaRenovacionMapeo.ingresoLinkImprimirFinalProcesada()){	
						objFuncionesGenerales.callPasosAcierto(1, "", "" ,"en el Link Imprimir");
						TipoLog="1";
					}else{
						TipoLog="0";			

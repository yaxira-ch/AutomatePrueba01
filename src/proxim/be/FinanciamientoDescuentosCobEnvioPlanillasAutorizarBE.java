...
import proxim.dao.Mdl_Variables;
	...
	public class FinanciamientoDescuentosCobEnvioPlanillasAutorizarBE {
		...
		public static String GstrCMD_PRODUCTO=Mdl_Variables.Gstr_Ignore;
		public static String GstrTXT_FECHA_INICIO=Mdl_Variables.Gstr_Ignore;
		public static String GstrTXT_FECHA_FIN=Mdl_Variables.Gstr_Ignore;
		public static String GstrBTN_BUSCAR=Mdl_Variables.Gstr_Ignore;
		public static String GstrLNK_VER_LOTES_EXPIRADOS=Mdl_Variables.Gstr_Ignore;
		public static String GstrLNK_ENVIAR_EMAIL_EXPIRADOS=Mdl_Variables.Gstr_Ignore;
		public static String GstrTXT_CORREO_EXPIRADOS=Mdl_Variables.Gstr_Ignore;
		public static String GstrTXT_MENSAJE_CORREO_EXPIRADOS=Mdl_Variables.Gstr_Ignore;
		public static String GstrBTN_ENVIAR_CORREO_EXPIRADOS=Mdl_Variables.Gstr_Ignore;
		public static String GstrBTN_ACEPTAR_CORREO_EXPIRADOS=Mdl_Variables.Gstr_Ignore;
		public static String GstrLNK_EXPORTAR_EXCEL_EXPIRADOS=Mdl_Variables.Gstr_Ignore;
		public static String GstrLNK_EXPORTAR_PDF_EXPIRADOS=Mdl_Variables.Gstr_Ignore;
		public static String GstrLNK_IMPRIMIR_EXPIRADOS=Mdl_Variables.Gstr_Ignore;
		public static String GstrLNK_REGRESAR_EXPIRADOS=Mdl_Variables.Gstr_Ignore;
		...
		public boolean FinanDescuentosCobEnvioPlanillasAutorizar(ResultSet Rst_Funcionalidad, int intOpcion){
			...
			try {
				...
				GstrLNK_VER_LOTES_EXPIRADOS= Rst_Funcionalidad.getObject("LNK_VER_LOTES_EXPIRADOS") != null ? Rst_Funcionalidad.getString("LNK_VER_LOTES_EXPIRADOS") : Mdl_Variables.Gstr_Ignore;
				GstrLNK_ENVIAR_EMAIL_EXPIRADOS= Rst_Funcionalidad.getObject("LNK_ENVIAR_EMAIL_EXPIRADOS") != null ? Rst_Funcionalidad.getString("LNK_ENVIAR_EMAIL_EXPIRADOS") : Mdl_Variables.Gstr_Ignore;
				GstrTXT_CORREO_EXPIRADOS= Rst_Funcionalidad.getObject("TXT_CORREO_EXPIRADOS") != null ? Rst_Funcionalidad.getString("TXT_CORREO_EXPIRADOS") : Mdl_Variables.Gstr_Ignore;
				GstrTXT_MENSAJE_CORREO_EXPIRADOS= Rst_Funcionalidad.getObject("TXT_MENSAJE_CORREO_EXPIRADOS") != null ? Rst_Funcionalidad.getString("TXT_MENSAJE_CORREO_EXPIRADOS") : Mdl_Variables.Gstr_Ignore;
				GstrBTN_ENVIAR_CORREO_EXPIRADOS= Rst_Funcionalidad.getObject("BTN_ENVIAR_CORREO_EXPIRADOS") != null ? Rst_Funcionalidad.getString("BTN_ENVIAR_CORREO_EXPIRADOS") : Mdl_Variables.Gstr_Ignore;
				GstrBTN_ACEPTAR_CORREO_EXPIRADOS= Rst_Funcionalidad.getObject("BTN_ACEPTAR_CORREO_EXPIRADOS") != null ? Rst_Funcionalidad.getString("BTN_ACEPTAR_CORREO_EXPIRADOS") : Mdl_Variables.Gstr_Ignore;
				GstrLNK_EXPORTAR_EXCEL_EXPIRADOS= Rst_Funcionalidad.getObject("LNK_EXPORTAR_EXCEL_EXPIRADOS") != null ? Rst_Funcionalidad.getString("LNK_EXPORTAR_EXCEL_EXPIRADOS") : Mdl_Variables.Gstr_Ignore;
				GstrLNK_EXPORTAR_PDF_EXPIRADOS= Rst_Funcionalidad.getObject("LNK_EXPORTAR_PDF_EXPIRADOS") != null ? Rst_Funcionalidad.getString("LNK_EXPORTAR_PDF_EXPIRADOS") : Mdl_Variables.Gstr_Ignore;
				GstrLNK_IMPRIMIR_EXPIRADOS= Rst_Funcionalidad.getObject("LNK_IMPRIMIR_EXPIRADOS") != null ? Rst_Funcionalidad.getString("LNK_IMPRIMIR_EXPIRADOS") : Mdl_Variables.Gstr_Ignore;
				GstrLNK_REGRESAR_EXPIRADOS= Rst_Funcionalidad.getObject("LNK_REGRESAR_EXPIRADOS") != null ? Rst_Funcionalidad.getString("LNK_REGRESAR_EXPIRADOS") : Mdl_Variables.Gstr_Ignore;
